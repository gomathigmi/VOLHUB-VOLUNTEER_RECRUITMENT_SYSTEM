            ...
            <Box className="w-full min-h-screen flex flex-col lg:flex-row p-4 gap-4 bg-customDarkBlue">
                ...
                <Box className="w-full lg:w-2/3 overflow-y-auto no-scrollbar">
                    ...
                    >
                        ...
                        <Box className="flex gap-3 justify-center">
                            <Button className="flex items-center gap-2" colorScheme="gray.100" variant="ghost">
                                <MdOutlinePermMedia className="text-white" />
                                <Text className="text-white">Media</Text>
                            </Button>
                            <Button className="flex items-center gap-2" colorScheme="gray.100" variant="ghost">
                                <MdEvent className="text-white"/>
                                <Text className="text-white">Event</Text>
                            </Button>
                            <Button className="flex items-center gap-2" colorScheme="gray.100" variant="ghost">
                                <MdArticle className="text-white"/>
                                <Text className="text-white">Article</Text>
                            </Button>
                        </Box>
                    </Box>
                    {/* --------------Post------------ */}
                    {Posts.map((item, index) => (
                        ...
                        >
                            ...
                            <Box className="flex items-center gap-3">
                                ...
                                <Box>
                                    <Text className="font-semibold text-gray-100">{item.name}</Text>
                ...
                <Box className="w-full lg:w-1/3 flex flex-col gap-4">
                    ...
                    <Box className="relative bg-customBg rounded-lg">
                        <Box className="flex justify-center font-semibold p-4 text-2xl text-custompink text-white" cursor={'pointer'}>My Profile</Box>
                        {/* Banner and Image */}
                        <Box
                        ...
                        <Box className="text-center px-4 mt-16">
                            <Text fontSize={'xl'} className="font-light text-white">{dbUser?.name}</Text>
                            <Text fontSize={'lg'} className="font-light text-white">✨ Volunteering: A Pathway to Purpose ✨</Text>
                        </Box>
                        ...
                        <Box className="flex justify-center mt-6 gap-10">
                            <Box className="flex flex-col items-center">
                                <CountUp start={0} end={6000} duration={2.75} separator=",">
                                    {({ countUpRef }) => (
                                        <Text fontSize={'2xl'} className="font-bold text-white" ref={countUpRef} />
                                    )}
                                </CountUp>
                                <Text fontSize={'lg'} className="font-light text-white">Following</Text>
                            </Box>
                            <Box className="flex flex-col items-center">
                                ...
                                <Text fontSize={'lg'} className="font-light text-white">Followers</Text>
                            </Box>
                        </Box>
                    </Box>
